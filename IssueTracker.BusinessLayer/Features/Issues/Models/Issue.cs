...
using IssueTracker.BusinessLayer.Features.Comments.Models;
using IssueTracker.BusinessLayer.Features.Projects.Models;
using IssueTracker.BusinessLayer.Features.Sprints.Models;
...
namespace IssueTracker.BusinessLayer.Features.Issues.Models
{
    public class Issue
    {
